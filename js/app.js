...
(() => {
  const sheetTemplates = {
    report: { title: "Report Hazard", html: `<div class="gridly-v2-tiles gridly-v2-report-tiles">${["Flooding","Ice","Debris","Crash / Wreck","Construction","Road Closed","Disabled Vehicle"].map((i)=>`<button class="gridly-v2-tile gridly-v2-report-action" data-v2-action="report-open" type="button"><span>${i}</span></button>`).join("")}</div><div class="gridly-v2-list gridly-v2-report-ctas"><button class="primary-btn" data-v2-action="report-open" type="button">Use My Location</button><button class="secondary-btn" data-v2-action="report-open" type="button">Tap Map Location</button></div>` },
  ...
  function triggerV2DockAdapter(action) {
    const bridges = {
  ...
  function bindV2SheetActions() {
    ...
    body.querySelectorAll("[data-v2-action]").forEach((button) => {
      button.addEventListener("click", () => triggerV2DockAdapter(button.dataset.v2Action || ""));
    });
  }
  function bindV2(){
