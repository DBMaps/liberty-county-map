...
(() => {
  ...
  const sheetTemplates = {
    ...
    alerts: { title: "Alerts", html: `<div class="gridly-v2-list"><p class="gridly-v2-sheet-copy">Alerts adapters now use canonical intelligence rendering.</p><p class="gridly-v2-sheet-copy" data-v2-precondition-helper hidden></p><button class="primary-btn" data-v2-action="alerts-open" type="button">Open Alerts Center</button><button class="secondary-btn" data-v2-action="alerts-manage-open" type="button">Manage Alerts</button></div>` },
  ...
  function triggerV2DockAdapter(action, payload = {}) {
    ...
    const bridges = {
      ...
      "alerts-manage-open": () => {
        markV2BlockedInteraction("alerts-manage-open", getV2PreconditionsState().alertsReason);
        triggerV2DockAdapter("settings-alert-preferences");
      },
