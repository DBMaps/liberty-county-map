...
(() => {
  ...
  function openPortraitV2Sheet(type) {
    ...
    activeSheet = type; title.textContent = template.title; body.innerHTML = templateHtml; bindV2SheetActions(); sheet.hidden = false; backdrop.hidden = false; body.hidden = false;
    sheet.style.display = "";
