...
(() => {
  const reportTileIcons = {
    "Flooding": `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 3.8c2 2.5 4.8 6.1 4.8 9a4.8 4.8 0 1 1-9.6 0c0-2.9 2.8-6.5 4.8-9Z"/><path d="M9.4 13.7c.3 1.2 1.2 2.1 2.6 2.3"/></svg>`,
    "Ice": `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="m12 3.5 1.6 3.3 3.7.5-2.7 2.6.6 3.8-3.2-1.7-3.2 1.7.6-3.8-2.7-2.6 3.7-.5L12 3.5Z"/><path d="M12 13.2v7.3"/></svg>`,
    "Debris": `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="m5 16 3-5 3 2 4-6 4 9H5Z"/><circle cx="9" cy="8" r="1.4"/></svg>`,
    "Crash / Wreck": `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M3.6 14.6h7.4l2-2.9h7.4v4.8h-1.9a2 2 0 0 1-3.9 0H9.5a2 2 0 0 1-3.9 0H3.6v-1.9Z"/><path d="m11 11.7-2.3-2.1m6.8 2.1 2.2-2.1"/></svg>`,
    "Construction": `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M12 3.1 21 19H3L12 3.1Z"/><path d="M9 13.3h6M10.2 15.8h3.6"/></svg>`,
    "Road Closed": `<svg viewBox="0 0 24 24" aria-hidden="true"><circle cx="12" cy="12" r="8.2"/><path d="M8 12h8"/></svg>`,
    "Disabled Vehicle": `<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M4 14.8h16v2.4h-1.8a2 2 0 0 1-3.9 0H9.7a2 2 0 0 1-3.9 0H4v-2.4Zm2.5-4.8h7.6l1.9 2.8H5.3L6.5 10Z"/><path d="m16.9 6.3 2.8 2.8m0-2.8-2.8 2.8"/></svg>`
  };
  const sheetTemplates = {
    report: { title: "Report Hazard", html: `<div class="gridly-v2-tiles">${["Flooding","Ice","Debris","Crash / Wreck","Construction","Road Closed","Disabled Vehicle"].map((i)=>`<button class="gridly-v2-tile" type="button"><span class="gridly-v2-report-tile-icon">${reportTileIcons[i] || ""}</span><span>${i}</span></button>`).join("")}</div><div class="gridly-v2-list"><button class="primary-btn" type="button">Use My Location</button><button class="secondary-btn" type="button">Tap Map Location</button></div>` },
