...
(() => {
  ...
  function buildAlertsSurfaceHtml() {
    ...
    const emptyState = !alerts.hasActiveAlerts
      ? `<p class="gridly-v2-sheet-copy"><strong>No active delays nearby.</strong></p><p class="gridly-v2-sheet-copy">Routes currently clear.</p><p class="gridly-v2-sheet-copy">No recent crossing disruptions reported.</p>`
      : "";
    return `<div class="gridly-v2-list">
      <p class="gridly-v2-sheet-copy"><strong>Nearby delays:</strong> ${alerts.nearbySummary}</p>
      <p class="gridly-v2-sheet-copy"><strong>Route watch:</strong> ${alerts.routeImpactSummary}</p>
      <p class="gridly-v2-sheet-copy"><strong>Recent hazard activity:</strong> ${alerts.recentHazardCount} in the last hour</p>
      <p class="gridly-v2-sheet-copy"><strong>Alert readiness:</strong> ${alerts.readinessSummary}</p>
      ${emptyState}
      ...
      <button class="secondary-btn" data-v2-action="settings-alert-preferences" type="button">Alert Preferences</button>
    </div>`;
  }
  ...
  function triggerV2DockAdapter(action, payload = {}) {
    ...
    const bridges = {
      ...
      "alerts-manage-open": () => openSmartAlertsModal(),
