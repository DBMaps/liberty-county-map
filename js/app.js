  ...
  function triggerV2DockAdapter(action, payload = {}) {
    ...
    const bridges = {
      ...
      "alerts-manage-open": () => {
        ...
        if (typeof openSmartAlertsModal === "function" && els.smartAlertsModal) openSmartAlertsModal();
        else {
          v1372AlertsActionDebug.lastAlertsActionFailureReason = "smart_alerts_modal_unavailable";
          setConfirmation("Alerts management is temporarily unavailable.", "error");
        }
      },
      "alerts-preferences-open": () => {
        v1372AlertsActionDebug.alertPreferencesActionHandled = true;
        if (typeof openSmartAlertsModal === "function" && els.smartAlertsModal) {
          openSmartAlertsModal();
          const preferencesAnchor = els.smartAlertsModal.querySelector("#smartAlertsPrefs") || els.smartAlertsModal.querySelector("[data-smart-alerts-prefs]");
          ...
          setConfirmation("Open Alerts to set your preferences for this device.", "error");
        }
      },
