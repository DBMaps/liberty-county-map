...
(() => {
  ...
  window.gridlyPortraitV2Debug = function(){
    ...
    const utilityControlIndependentlyAligned = Boolean(document.querySelector("#gridlyPortraitV2 .gridly-v2-header-right .gridly-v2-icon-btn"));
