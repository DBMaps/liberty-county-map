...
(() => {
  ...
  window.gridlyPortraitV2Debug = function(){
    ...
    const topHeaderTypographyRefined = Boolean(document.querySelector("#gridlyPortraitV2 .gridly-v2-brand span") && document.querySelector("#gridlyPortraitV2 .gridly-v2-watch span"));
    ...
    const v133BrandFoundationApplied = Boolean(document.querySelector("#gridlyPortraitV2 .gridly-v2-mark") && document.querySelector("#gridlyPortraitV2 .gridly-v2-wordmark"));
    ...
    const gridlyMarkFoundationApplied = Boolean(document.querySelector("#gridlyPortraitV2 .gridly-v2-mark i"));
    const wordmarkPolished = Boolean(document.querySelector("#gridlyPortraitV2 .gridly-v2-wordmark"));
