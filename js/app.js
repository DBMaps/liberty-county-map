...
(() => {
  ...
  function triggerV2DockAdapter(action, payload = {}) {
    const bridges = {
      ...
      "report-use-location": () => {
        if (!selectedV2HazardType) return;
      ...
      "alerts-manage-open": () => triggerV2DockAdapter("settings-alert-preferences"),
