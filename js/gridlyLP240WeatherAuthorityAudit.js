(function initGridlyLP240WeatherAuthorityAudit(globalScope) {
  ...
  function auditRuntime() {
    ...
    const result = {
      ...
      startupWeatherActivationEligible: connectorAudit.startupWeatherActivationEligible === true,
      startupWeatherActivationTriggered: connectorAudit.startupWeatherActivationTriggered === true,
      startupWeatherActivationReason: connectorAudit.startupWeatherActivationReason || null,
      connectorLastAttemptAt: connectorAudit.connectorLastAttemptAt || connectorAudit.lastRequestAt || null,
      connectorLastSuccessAt: connectorAudit.connectorLastSuccessAt || connectorAudit.lastSuccessAt || null,
