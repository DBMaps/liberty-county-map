(function initGridlyPackageRegistry(globalScope) {
  ...
  function validateIntelligenceFoundation(registryRef) {
    ...
    const controlledMigratedProviderIds = Object.freeze(["community-reports", "drivetexas"]);
    ...
    return Object.freeze({
      valid: intelligencePackages.length === 5 && communityReportsControlledMigrated === true && driveTexasControlledMigrated === true && trustModelActivated === false && freshnessModelActivated === false && confidenceModelActivated === false && invalidPackages.length === 0,
      operationalRegion: SOUTHEAST_TEXAS_OPERATIONAL_REGION,
