...
assert(app.includes('Confirm Still Active') && app.includes('Mark Cleared'), 'community popup actions preserved');
...
assert(app.includes('return gridlyLp019SafeText(record.county || record.countyName'), 'county fallback still works');
