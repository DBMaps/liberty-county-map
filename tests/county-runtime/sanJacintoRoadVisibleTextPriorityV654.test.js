...
includes('const locationLabel = crossingLocationEvidence?.locationLineLabel || authoritativeDisplayLocation?.label || normalizeGridlyAlertCardLocationLabel(alert);', 'alert card consumer model prefers authoritative display location before community fallback labels');
...
const alertIndex = source.indexOf('const locationLabel = crossingLocationEvidence?.locationLineLabel || authoritativeDisplayLocation?.label || normalizeGridlyAlertCardLocationLabel(alert);');
