...
assert(appSource.includes('getGridlyRegionalCrossingVisibilityPolicy'), 'Operational county crossing inventory rendering is governed by regional visibility policy');
