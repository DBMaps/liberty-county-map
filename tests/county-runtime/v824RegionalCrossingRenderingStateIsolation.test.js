...
assert(appSource.includes('function gridlyResolveCrossingRenderInventory'), 'rendering has a shared governed-inventory resolver');
assert(appSource.includes('gridlyResolveCrossingRenderInventory(canonicalResolution)'), 'renderCrossings obtains policy input from the shared governed-inventory resolver');
