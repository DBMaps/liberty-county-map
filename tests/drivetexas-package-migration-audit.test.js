...
const audit = context.gridlyDriveTexasPackageMigrationAudit();

assert.strictEqual(audit.auditName, "V762 DriveTexas Package Metadata Ownership Migration");
assert.strictEqual(audit.migrationVersion, "V762");
