...
const audit = context.gridlyDriveTexasProviderCertificationAudit();

assert.strictEqual(audit.auditName, "V763 DriveTexas Provider Certification");
assert.strictEqual(audit.certificationVersion, "V763");
