...
assert.strictEqual(intelligenceAudit.weatherControlledMigrated, true);
assert.strictEqual(intelligenceAudit.railControlledMigrated, true);
assert.strictEqual(JSON.stringify(intelligenceAudit.controlledMigratedProviders), JSON.stringify(["community-reports", "drivetexas", "weather", "rail"]));
assert.strictEqual(JSON.stringify(intelligenceAudit.remainingPlannedProviders), JSON.stringify(["Future Providers"]));
