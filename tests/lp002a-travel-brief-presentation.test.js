...
assert.match(app, /title: "Official Roadways"/, 'Travel Brief includes DriveTexas section');
...
assert.match(app, /No community travel conditions reported\./, 'Community empty state is consumer friendly');
assert.match(app, /No official roadway advisories nearby\./, 'DriveTexas empty state is consumer friendly');
assert.match(app, /No travel-impacting weather\./, 'Weather empty state is travel-impact only');
assert.match(app, /sourceLine: gridlyAwarenessSourceLabel\("community"\)/, 'Travel Brief includes community source context');
assert.match(app, /sourceLine: gridlyAwarenessSourceLabel\("official-roadways"\)/, 'Travel Brief includes official source context');
