...
assert(visibleHtml.includes('Alternating lane closures on US 59. Expect delays while crews install a cable median barrier.'), 'live-shaped Road Closed location line is cleaned');
