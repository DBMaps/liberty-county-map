...
assert(serviceWorker.includes('const GRIDLY_SW_VERSION = "lp244.21e-local-certification";'), 'legacy lifecycle contract follows the governed current service-worker version authority');
assert(serviceWorker.includes('const GRIDLY_CLOSURE_CACHE_NAME = "gridly-pwa-shell-lp24421e-v1";'), 'legacy lifecycle contract follows the governed current cache authority');
