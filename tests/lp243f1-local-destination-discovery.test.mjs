...
test('LP243.F4 has a unique production app asset identity in the expected script position', () => {
  const appAsset = '<script src="js/app.js?v=243f4-score-decomposition"></script>';
