...
test("protected portrait CSS stays outside LP243.H containment under H4 identities", () => {
  ...
  assert.match(html, /js\/app\.js\?v=(?:243h10i-search-tray-containment|243i1-shared-v2-sheet-landscape-eligibility|243i21s1-imagery-only-satellite|243i1h4-final-history-performance-closure)/);
});
