...
const mediaEnd = css.indexOf("\n}\n\n@media (prefers-reduced-motion", h10kStart);
...
const h10k = css.slice(h10kStart, mediaEnd);
const shortLandscape = (width, height) => width > height && height <= 500;

test("H10K is confined to expanded short landscape", () => {
  assert.ok(h10bStart >= 0 && h10hStart > h10bStart && h10iStart > h10hStart && h10jStart > h10iStart && h10kStart > h10jStart && mediaEnd > h10kStart);
