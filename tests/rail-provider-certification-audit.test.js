...
const audit = context.gridlyRailProviderCertificationAudit();

assert.strictEqual(audit.auditName, "V773 Rail Provider Certification");
assert.strictEqual(audit.certificationVersion, "V773");
