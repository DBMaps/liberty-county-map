...
& $EstablishedProtectedValidationCommand --wave 'LP18810-NP-001' --county-fips $fips --environment 'OWNER_CONTROLLED_PROTECTED_NON_PRODUCTION' --no-production-deployment --no-activation --evidence-output 'evidence/lp18811/execution-results/owner-result.json'
