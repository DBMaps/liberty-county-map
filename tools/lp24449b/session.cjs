...
module.exports=async function session(options={}){
  const server=http.createServer((req,res)=>{
    ...
    const file=path.resolve(root,options.baseline&&pathname==='/js/app.js'?'.artifacts/lp24449b/baseline-app.js':options.baseline&&pathname==='/js/gridlyWeatherLiveConnector.js'?'.artifacts/lp24449b/baseline-weather.js':'.'+(pathname==='/'?'/index.html':pathname));
