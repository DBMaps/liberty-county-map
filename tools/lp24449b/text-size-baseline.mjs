...
for(const baseline of [true,false]){
 ...
 try{
  ...
  runs.push({baseline,sourceHash:crypto.createHash('sha256').update(fs.readFileSync(`${root}/${baseline?'.artifacts/lp24449b/baseline-app.js':'js/app.js'}`)).digest('hex'),controls,screenshot});
