...
fs.writeFileSync('.artifacts/lp24449b/final-weather-tests.log',log);
fs.writeFileSync('reports/lp24449b/final-weather-tests.json',JSON.stringify({files,weatherHash,exitCode:result.status,log},null,2)+'\n');
