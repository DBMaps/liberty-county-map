...
fs.readFileSync=function(file,...args){
  ...
  return read.call(this,resolved===target?path.resolve('.artifacts/lp24449b1/baseline-app.js'):resolved===path.resolve('js/gridlyWeatherLiveConnector.js')?path.resolve('.artifacts/lp24449b1/baseline-weather.js'):file,...args);
};
