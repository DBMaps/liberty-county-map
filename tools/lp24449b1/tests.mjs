...
const baselineFiles=files.map(file=>{
 ...
 let source=execFileSync('git',['show',`5538432be3bfe12c6dc0d3f34dcc9fd97c6edc3c:${file}`],{cwd:root,encoding:'utf8'});
...
for(const baseline of [false,true]){
 const args=[...(baseline?['--require','./tools/lp24449b1/baseline-test-loader.cjs']:[]),'--test','--test-concurrency=2',...(baseline?baselineFiles:[...files,'tests/lp24449a-home-cache.test.cjs','tests/lp24449a-search-publication.test.cjs','tests/lp24449a-canonical-home-resolution-cache.test.cjs'])];
