...
export async function verifyPostActivation({root=DEFAULT_ROOT,reinspect=postActivation}={}){
 ...
 // Package evidence is deliberately a statewide summary. County-level certification
 // comes from the production package, its county manifest, and reconciliation above.
